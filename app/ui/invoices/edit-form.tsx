...
export default function EditInvoiceForm({
  ...
  invoice: InvoiceForm;             // <-- Asegúrate que este tipo SÍ tiene `id: string`
  customers: CustomerField[];
}) {
  // ⚠️ Wrapper sin `bind` (evita subrayado y problemas de tipos)
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                type="number"
                step="0.01"
                // Si en DB guardas centavos, usa: defaultValue={invoice.amount / 100}
